  ...
  return (
    <>
      <FaqContainer>
        ...
        <Section question="Is the Pulsechain Name Service (ANS) only for storing an Pulsechain address?">
        ...
        <Section question="How much does it cost to register a .arb name?">
          ...
          <ul>
            <li>5+ character .arb names: $5 in ARB per year.</li>
            <li>4 character .arb names: $169 in ARB per year.</li>
            <li>3 character .arb names $555 in ARB per year.</li>
          </ul>
        ...
        <Section question="How much gas does it cost to register and extend registration?">
          ...
          (register, set resolver and set arb address) hence the gas cost will
        ...
        <Section question="My transaction at step 3 failed">
          ...
          registered with enough ARB. Please try again from step3.
          <br />
        ...
        <Section question="I cannot see the names I registered in my wallet">
          ...
          under "My Account" on our site or your ARB address under the name
        ...
        <Section question="What is a Primary ANS Name record?">
          ...
          Pulsechain address point to an ANS name. This allows dapps to find and
          display your ANS name when you connect to them with your Pulsechain
        ...
        <Section question="How do I transfer my name?">
          ...
          the new Pulsechain account. Since ".arb" names are ERC721 compliant
          ...
          names, it may be a good idea for you to set the ARB Address record to
        ...
        <Section question="What happens if I forget to extend the registration of a name?">
          ...
          released name continues to resolve your ARB address until the new
          owner overwrites it.
        </Section>
        ...
        <Section question="I lost access to the Pulsechain account that owns a name I registered. Can I still extend its registration period?">
          Any Pulsechain account can pay to extend the registration of any ANS
